...
const services = [
  ...
  },
  {
    ...
    title: "Сканирование",
    description:
      "Сканируем на профессиональных сканерах Konica, Nikon, Epson. Возможна ручная цветокоррекция каждого кадра для получения максимального качества.",
    features: ["Базовое разрешение", "Высокое разрешение", "TIFF без сжатия", "Цветокоррекция"],
  },
];
