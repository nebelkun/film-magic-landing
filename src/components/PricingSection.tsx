    ...
    <section id="pricing" className="py-24 md:py-32">
      <div className="container mx-auto px-6">
        ...
        <p className="text-secondary-foreground/70 text-sm md:text-base text-center max-w-2xl mx-auto mt-12 leading-relaxed">
          Срок выполнения заказа - от 2 до 12 дней (обычно все успеем за 1-7 дней), в зависимости от количества накопившихся плёнок. Проявка обычно проводится по воскресеньям, практически каждую неделю. В ближайшее несколько месяцев мы планируем сократить срок выполнения до нескольких часов.
        </p>
      </div>
    </section>
  );
