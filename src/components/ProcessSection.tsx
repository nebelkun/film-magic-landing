const steps = [
  { number: "01", title: "Оставьте пленку в фотостудии", desc: "Привезите лично или отправьте доставкой График студии плавающий" },
  { number: "02", title: "Проявка", desc: "Бережно проявляем в свежей химии с точным контролем температуры и времени" },
  { number: "03", title: "Сканирование", desc: "Сканируем каждый кадр с ручной цветокоррекцией. Но можем и без нее, если попросите" },
